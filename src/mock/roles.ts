...
export const ALL_PERMISSIONS: { key: PermissionKey; label: string; group: string }[] = [
  ...
  { key: "REQUEST_VIEW", label: "View Material Requests", group: "STOCK MANAGEMENT" },
  { key: "REQUEST_CREATE", label: "Create Material Request", group: "STOCK MANAGEMENT" },
  { key: "STORE_APPROVAL", label: "Store Approval & Review", group: "STOCK MANAGEMENT" },
  { key: "REQUEST_ISSUE", label: "Issue Requested Goods", group: "STOCK MANAGEMENT" },
  { key: "TRANSFER_CREATE", label: "Transfer Material", group: "STOCK MANAGEMENT" },
...
export const INITIAL_ROLES: Role[] = [
  ...
  },
  {
    id: "role-store",
    name: "Store",
    description: "Full store and warehouse operations: Master Data, Stock Balance, Requisitions, Store Approval, Transfer, GR, GI, Adjustments, Transactions, and Reports",
    permissions: [
      "MASTER_VIEW",
      "MASTER_CREATE",
      "MASTER_EDIT",
